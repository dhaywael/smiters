...
if ( ! function_exists('ann_get_not_selected_text') ) {
	/**
	 ...
	 */
	function ann_get_not_selected_text( $label ) {
		return apply_filters( 'ann_filter_not_selected_text',
								sprintf( apply_filters( 'ann_filter_not_selected_mask', __( '- %s -', 'ann' ) ), $label )
							);
	}
}

if ( ! function_exists( 'ann_get_list_range' ) ) {
	/**
	 ...
	 */
	function ann_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'ann_get_list_styles' ) ) {
	/**
	 ...
	 */
	function ann_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'ann' ), $i );
		}
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function ann_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'ann' ),
			'no'  => esc_html__( 'No', 'ann' ),
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function ann_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'ann_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'ann' ),
				0         => esc_html__( 'No', 'ann' ),
			)
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
...
if ( ! function_exists( 'ann_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function ann_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'ann' ),
			'off' => esc_html__( 'Off', 'ann' ),
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function ann_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'ann' ),
			'hide' => esc_html__( 'Hide', 'ann' ),
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function ann_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'ann' ),
			'hidden'  => esc_html__( 'Hidden', 'ann' ),
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_directions' ) ) {
	/**
	 ...
	 */
	function ann_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'ann' ),
			'vertical'   => esc_html__( 'Vertical', 'ann' ),
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function ann_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'ann_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'ann' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'ann' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'ann' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'ann' ),
...
if ( ! function_exists( 'ann_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function ann_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'ann_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'ann' ),
				'icon'    => esc_html__( 'Icon', 'ann' ),
				'icons'   => esc_html__( 'Icons', 'ann' ),
				'zoom'    => esc_html__( 'Zoom', 'ann' ),
				'fade'    => esc_html__( 'Fade', 'ann' ),
				'slide'   => esc_html__( 'Slide', 'ann' ),
				'pull'    => esc_html__( 'Pull', 'ann' ),
				'border'  => esc_html__( 'Border', 'ann' ),
				'excerpt' => esc_html__( 'Excerpt', 'ann' ),
				'info'    => esc_html__( 'Info', 'ann' ),
			)
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'ann_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function ann_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'ann' ),
				'fullpost' => esc_html__( 'Full post', 'ann' ),
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function ann_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'ann' ),
...
if ( ! function_exists( 'ann_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function ann_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = ann_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			ann_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = ann_array_merge( array( 'hide' => ann_get_not_selected_text( esc_html__( 'Select widgets', 'ann' ) ) ), $list );
		}
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function ann_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'ann_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'ann' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'ann' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'ann' ),
...
if ( ! function_exists( 'ann_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function ann_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'ann_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'ann' ),
				'below' => esc_html__( 'Below the content', 'ann' ),
				'float' => esc_html__( 'Floating bar', 'ann' ),
			)
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'ann_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function ann_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'ann_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function ann_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'ann_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'ann_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function ann_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'ann_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function ann_get_list_header_positions( $prepend_inherit = false ) {
		$list = array(
			'default' => esc_html__( 'Default', 'ann' ),
			'over'    => esc_html__( 'Over', 'ann' ),
			'under'   => esc_html__( 'Under', 'ann' ),
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function ann_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'ann_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function ann_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'ann' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'ann' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'ann_filter_allow_fullscreen', $force_fullscreen || ann_get_theme_setting( 'allow_fullscreen' ) || ann_get_edited_post_type() == 'page' ) ) {
			$list['fullwide']   = array(
									'title' => esc_html__( 'Fullwidth', 'ann' ),
									'icon'  => 'images/theme-options/body-style/fullwide.png',
									);
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'ann' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'ann_filter_list_body_styles', $list );
		return $prepend_inherit
					? ann_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'ann_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function ann_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'ann_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'ann' ),
...
if ( ! function_exists( 'ann_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function ann_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'ann_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'ann' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'ann' ),
...
if ( ! function_exists( 'ann_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function ann_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'ann_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'ann' ),
				'date'       => esc_html__( 'Published date', 'ann' ),
				'modified'   => esc_html__( 'Modified date', 'ann' ),
				'views'      => esc_html__( 'Views', 'ann' ),
				'likes'      => esc_html__( 'Likes', 'ann' ),
				'comments'   => esc_html__( 'Comments', 'ann' ),
				'share'      => esc_html__( 'Share links', 'ann' ),
				'categories' => esc_html__( 'Categories', 'ann' ),
				'edit'       => esc_html__( 'Edit link', 'ann' ),
			)
		);
...
if ( ! function_exists( 'ann_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function ann_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'ann_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'ann_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function ann_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'ann' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'ann' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'ann_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? ann_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'ann_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function ann_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'ann_filter_list_single_styles', ann_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? ann_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'ann_get_list_categories' ) ) {
	/**
	 ...
	 */
	function ann_get_list_categories( $prepend_inherit = false ) {
		$list = ann_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'ann_filter_term_name', $cat->name, $cat );
				}
			}
			ann_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_terms' ) ) {
	/**
	 ...
	 */
	function ann_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = ann_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'ann_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			ann_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_posts_types' ) ) {
	/**
	 ...
	 */
	function ann_get_list_posts_types( $prepend_inherit = false ) {
		$list = ann_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'ann_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'ann' ),
				)
			);
			ann_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_posts' ) ) {
	/**
	 ...
	 */
	function ann_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		$opt = array_merge(
			array(
				'post_type'        => 'post',
				'post_status'      => 'publish',
		...
		$list = ann_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? ann_get_not_selected_text( esc_html__( 'Not selected', 'ann' ) ) : $opt['not_selected'];
			}
			$args = array(
...
if ( ! function_exists( 'ann_get_list_users' ) ) {
	/**
	 ...
	 */
	function ann_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = ann_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = ann_get_not_selected_text( esc_html__( 'Not selected', 'ann' ) );
			$users        = get_users(
				array(
			...
			ann_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_menus' ) ) {
	/**
	 ...
	 */
	function ann_get_list_menus( $prepend_inherit = false ) {
		$list = ann_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			$list['default'] = esc_html__( 'Default', 'ann' );
			...
			ann_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_icons' ) ) {
	/**
	 ...
	 */
	function ann_get_list_icons( $style = 'icons', $prepend_inherit = false ) {
		$lists = get_transient( 'ann_list_icons' );
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			if ( 'icons' == $style ) {
				$lists[ $style ] = ann_array_from_list( ann_get_list_icons_classes( $prepend_inherit ) );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = ann_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = ann_get_list_images( false, 'svg' );
			}
			if ( is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'ann_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'ann_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function ann_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : ann_parse_icons_classes( ann_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = ! is_array( $list ) ? array() : ann_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'ann_get_list_images' ) ) {
	/**
	 ...
	 */
	function ann_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'ann_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function ann_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'ann_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'ann' ),
				'link2'   => esc_html__( 'Accent 2', 'ann' ),
				'link3'   => esc_html__( 'Accent 3', 'ann' ),
				'dark'    => esc_html__( 'Dark', 'ann' ),
			)
		);
		return $prepend_inherit ? ann_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'ann' ) ), $list ) : $list;
	}
