...
WordPress version: required at least 5.0, tested up to 6.3.2
...
Please install and activate it before starting to use the theme ANN.
...
Theme documentation is available on https://ann.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in ANN is Fontello.
