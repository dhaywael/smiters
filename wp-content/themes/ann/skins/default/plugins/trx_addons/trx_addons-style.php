...
if ( ! function_exists( 'ann_trx_addons_get_css' ) ) {
	add_filter( 'ann_filter_get_css', 'ann_trx_addons_get_css', 10, 2 );
	function ann_trx_addons_get_css( $css, $args ) {
...
.sc_igenerator_form_field .sc_igenerator_form_field_inner > label,
