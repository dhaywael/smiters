...
if ( ! function_exists( 'ann_woocommerce_get_css' ) ) {
	add_filter( 'ann_filter_get_css', 'ann_woocommerce_get_css', 10, 2 );
	function ann_woocommerce_get_css( $css, $args ) {
...
$fdir = ann_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
