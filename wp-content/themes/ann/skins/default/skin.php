...
if ( ! function_exists( 'ann_skin_filter_disable_image_size_threshold' ) ) {
    add_action( 'after_setup_theme', 'ann_skin_filter_disable_image_size_threshold' );
    function ann_skin_filter_disable_image_size_threshold() {
        $disable_image_size_threshold = ann_is_on( ann_get_theme_option( 'disable_image_size_threshold' ) );
        if ( $disable_image_size_threshold ) {
