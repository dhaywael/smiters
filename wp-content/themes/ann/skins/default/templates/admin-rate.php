...
<div class="ann_admin_notice ann_rate_notice notice notice-info is-dismissible" data-notice="rate">
	...
	<h3 class="ann_notice_title"><a href="<?php echo esc_url( ann_storage_get( 'theme_rate_url' ) ); ?>" target="_blank">
		...
		echo esc_html(
			sprintf(
				...
				__( 'Rate our theme "%s", please', 'ann' ),
	...
	<div class="ann_notice_text">
		<p><?php echo wp_kses_data( __( "We are glad you chose our WP theme for your website. You've done well customizing your website and we hope that you've enjoyed working with our theme.", 'ann' ) ); ?></p>
		<p><?php echo wp_kses_data( __( "It would be just awesome if you spend just a minute of your time to rate our theme or the customer service you've received from us.", 'ann' ) ); ?></p>
		<p class="ann_notice_text_info"><?php echo wp_kses_data( __( '* We love receiving your reviews! Every time you leave a review, our CEO Henry Rise gives $5 to homeless dog shelter! Save the planet with us!', 'ann' ) ); ?></p>
	</div>
	<?php
	...
	<div class="ann_notice_buttons">
		...
		<a href="<?php echo esc_url( ann_storage_get( 'theme_rate_url' ) ); ?>" class="button button-primary" target="_blank"><i class="dashicons dashicons-star-filled"></i> 
			...
			echo esc_html( sprintf( __( 'Rate theme %s', 'ann' ), $ann_theme_obj->name ) );
			?>
		</a>
		<?php
